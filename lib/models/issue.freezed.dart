...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Issue&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.description, description) || other.description == description)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.status, status) || other.status == status)&&(identical(other.resolvedBy, resolvedBy) || other.resolvedBy == resolvedBy)&&(identical(other.resolvedAt, resolvedAt) || other.resolvedAt == resolvedAt)&&(identical(other.resolutionNotes, resolutionNotes) || other.resolutionNotes == resolutionNotes)&&const DeepCollectionEquality().equals(other.missingSignatories, missingSignatories));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,description,createdBy,createdAt,status,resolvedBy,resolvedAt,resolutionNotes,const DeepCollectionEquality().hash(missingSignatories));

@override
String toString() {
  return 'Issue(id: $id, type: $type, description: $description, createdBy: $createdBy, createdAt: $createdAt, status: $status, resolvedBy: $resolvedBy, resolvedAt: $resolvedAt, resolutionNotes: $resolutionNotes, missingSignatories: $missingSignatories)';
}
...
@useResult
$Res call({
 String id, IssueType type, String description, String createdBy,@JsonKey(fromJson: timestampFromJson, toJson: timestampToJson) DateTime createdAt, String status, String? resolvedBy,@JsonKey(fromJson: nullableTimestampFromJson, toJson: nullableTimestampToJson) DateTime? resolvedAt, String? resolutionNotes, List<SignatoryType> missingSignatories
});
...
/// Create a copy of Issue
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? type = null,Object? description = null,Object? createdBy = null,Object? createdAt = null,Object? status = null,Object? resolvedBy = freezed,Object? resolvedAt = freezed,Object? resolutionNotes = freezed,Object? missingSignatories = null,}) {
...
as String?,missingSignatories: null == missingSignatories ? _self.missingSignatories : missingSignatories // ignore: cast_nullable_to_non_nullable
as List<SignatoryType>,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  IssueType type,  String description,  String createdBy, @JsonKey(fromJson: timestampFromJson, toJson: timestampToJson)  DateTime createdAt,  String status,  String? resolvedBy, @JsonKey(fromJson: nullableTimestampFromJson, toJson: nullableTimestampToJson)  DateTime? resolvedAt,  String? resolutionNotes,  List<SignatoryType> missingSignatories)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Issue() when $default != null:
return $default(_that.id,_that.type,_that.description,_that.createdBy,_that.createdAt,_that.status,_that.resolvedBy,_that.resolvedAt,_that.resolutionNotes,_that.missingSignatories);case _:
  return orElse();
...
class _Issue implements Issue {
  const _Issue({required this.id, required this.type, required this.description, required this.createdBy, @JsonKey(fromJson: timestampFromJson, toJson: timestampToJson) required this.createdAt, this.status = 'Open', this.resolvedBy, @JsonKey(fromJson: nullableTimestampFromJson, toJson: nullableTimestampToJson) this.resolvedAt, this.resolutionNotes, final  List<SignatoryType> missingSignatories = const []}): _missingSignatories = missingSignatories;
...
@override final  String? resolutionNotes;
 final  List<SignatoryType> _missingSignatories;
@override@JsonKey() List<SignatoryType> get missingSignatories {
  if (_missingSignatories is EqualUnmodifiableListView) return _missingSignatories;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_missingSignatories);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Issue&&(identical(other.id, id) || other.id == id)&&(identical(other.type, type) || other.type == type)&&(identical(other.description, description) || other.description == description)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.status, status) || other.status == status)&&(identical(other.resolvedBy, resolvedBy) || other.resolvedBy == resolvedBy)&&(identical(other.resolvedAt, resolvedAt) || other.resolvedAt == resolvedAt)&&(identical(other.resolutionNotes, resolutionNotes) || other.resolutionNotes == resolutionNotes)&&const DeepCollectionEquality().equals(other._missingSignatories, _missingSignatories));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,type,description,createdBy,createdAt,status,resolvedBy,resolvedAt,resolutionNotes,const DeepCollectionEquality().hash(_missingSignatories));
...
/// Create a copy of Issue
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? type = null,Object? description = null,Object? createdBy = null,Object? createdAt = null,Object? status = null,Object? resolvedBy = freezed,Object? resolvedAt = freezed,Object? resolutionNotes = freezed,Object? missingSignatories = null,}) {
  return _then(_Issue(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,type: null == type ? _self.type : type // ignore: cast_nullable_to_non_nullable
as IssueType,description: null == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
...
as String?,resolvedAt: freezed == resolvedAt ? _self.resolvedAt : resolvedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,resolutionNotes: freezed == resolutionNotes ? _self.resolutionNotes : resolutionNotes // ignore: cast_nullable_to_non_nullable
as String?,missingSignatories: null == missingSignatories ? _self._missingSignatories : missingSignatories // ignore: cast_nullable_to_non_nullable
as List<SignatoryType>,
  ));
}
