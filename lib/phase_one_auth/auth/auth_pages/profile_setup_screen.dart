import 'package:auditlab/phase_one_auth/models/models_sector.dart' show Sector;
import 'package:auditlab/phase_two_core_features/fix_provider_scope.dart';
import 'package:auditlab/phase_one_auth/widgets/auth_text_field.dart';
import 'package:auditlab/phase_one_auth/widgets/primary_button.dart';
import 'package:auditlab/phase_one_auth/widgets/widgets_sector_selector.dart';
  ...
  Future<void> _saveProfile() async {
    ...
    try {
      ...
      if (mounted) {
        Navigator.of(
          context,
        ).pushReplacementNamed('/'); // Universal layout for all
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
